...
public class Menu {
	...
	public static void displaymenu()
    {
        ...
        System.out.println("10. find_cate <키워드>: 키워드가 카테고리에 포함된 모든 항목을 찾아서 출력합니다.");
        System.out.println("11. comp <번호>: 번호에 해당하는 항목을 완료처리합니다.");
        System.out.println("12. ls_comp: 완료처리된 항목들을 모두 출력합니다.");
        System.out.println("13. exit: 프로그램 실행을 종료합니다.");
